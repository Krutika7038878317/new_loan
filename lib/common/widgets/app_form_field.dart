...
class AppFormFieldState extends State<AppFormField> {
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      ...
      children: [
        Neumorphic(
          style: hasFocus || isNotEmpty||!isNotEmpty
          ...
          child: GestureDetector(
            child: Container(
              ...
              decoration: hasFocus || isNotEmpty||!isNotEmpty
                  ? null
                  : const BoxDecoration(
  ...
  bool validate() {
    final initialValue = widget.textEditingController != null
        ? widget.textEditingController!.text
        : '';
    bool isValid = widget.validator == null || widget.validator!(initialValue) == null;
